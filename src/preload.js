...
contextBridge.exposeInMainWorld('vortex', {
  ...
  searchMods: (query, version, page, index = 'relevance') => ipcRenderer.invoke('search-mods', query, version, page, index),
  ...
  getSandboxDiagnostics: (version) => ipcRenderer.invoke('get-sandbox-diagnostics', version),
  openDiagnosticsFolder: (version, kind) => ipcRenderer.invoke('open-diagnostics-folder', version, kind),
  exportSandboxDiagnostics: (version) => ipcRenderer.invoke('export-sandbox-diagnostics', version),
  ...
  getModHealth: (version) => ipcRenderer.invoke('get-mod-health', version),
